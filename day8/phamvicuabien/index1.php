...
<pre>
    - Biến cục bộ: chỉ có ảnh hưởng và chỉ được sử dụng được trong 1 không gian nhất định
    - Biến toàn cục: có ảnh hưởng và có thể sử dụng ở mọi nơi
    - Nếu teen biến bị trùng thì nếu sử dụng ngoài hàm thì php sẽ lấy giá trị của biến toàn cục
    ***
